...
// Copied from https://github.com/matrix-org/matrix-widget-api/blob/2e7134af232360bf1b2a818f072cc02793835d99/examples/widget/utils.js
...
function handleError(e) {
    console.error(e);
    $("#container").html("<div id='error'>There was an error with the widget :(</div>");
}
